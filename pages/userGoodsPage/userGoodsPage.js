...
//
import {
  getCustomerUserGoods, saveEditItems, delateItem
...
Page({
  ...
  _initData: function(){
    var data = {
      nxCugUserId: this.data.userInfo.nxCustomerUserEntity.nxCuUserId,
      nxCugJoinMyTemplate: 1,
    }
    var data = {
      nxCugUserId: 76,
...
// 
  ...
  toUserGoodsToJoin:function(e){
    wx.navigateTo({
      url: '../userGoodsToJoin/userGoodsToJoin?nxCustomerUserId=' +this.data.userInfo.nxCustomerId,
    })
